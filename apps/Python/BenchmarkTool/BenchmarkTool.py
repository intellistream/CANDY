...
class BenchmarkTool:
    ...
    def loadConfigFromFile(self, fileName,isRef=0,refTag ='flatGPU'):
        """
    ...
    def refFlag(self):
        return self.isRef
    def loadConfigFromDict(self, dict,isRef=0,refTag ='flatGPU'):
        """
