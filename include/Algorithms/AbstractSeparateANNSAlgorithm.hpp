...
class AbstractSeparateANNSAlgorithm {
 public:
   ...
   */
  virtual std::vector<torch::Tensor> searchTensor(const torch::Tensor& t,
                                                  int64_t k) = 0;
  /**
   ...
   */
  virtual std::vector<torch::Tensor> deleteTensor(const torch::Tensor& t,
                                                  int64_t k) = 0;
   ...
   */
  virtual std::vector<int64_t> findKnnTensor(const torch::Tensor& t,
                                             int64_t k) = 0;
