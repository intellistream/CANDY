...
bool DeadlockPrevention::acquire_lock(const std::string& transaction_id,
...
void DeadlockPrevention::release_lock(const std::string& transaction_id,
                                      const std::string& resource_id) {
  std::lock_guard<std::mutex> lock(graph_mutex);
...
std::optional<std::vector<std::string>> DeadlockPrevention::detect_deadlock(
...
bool DeadlockPrevention::has_cycle(
