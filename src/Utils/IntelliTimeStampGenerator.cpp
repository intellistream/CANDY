...
std::vector<INTELLI::IntelliTimeStampPtr> INTELLI::TimeStampGenerator::constructTimeStamps(
...
std::vector<INTELLI::IntelliTimeStampPtr> INTELLI::TimeStampGenerator::getTimeStamps() {
  return myTs;
}