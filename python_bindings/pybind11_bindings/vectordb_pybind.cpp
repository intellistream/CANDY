...
PYBIND11_MODULE(pycandy, m) {
  ...
  py::class_<CANDY_ALGO::DataLoaderTable, std::shared_ptr<CANDY_ALGO::DataLoaderTable>>(m, "DataLoaderTable")
      .def(py::init<>())
  ...
  py::class_<ConfigMap, std::shared_ptr<ConfigMap>>(m, "ConfigMap")
      ...
      .def("edit_u64", static_cast<void (ConfigMap::*)(const std::string&, uint64_t)>(&ConfigMap::edit),
             py::arg("key"), py::arg("value"))
      .def("edit_i64", static_cast<void (ConfigMap::*)(const std::string&, int64_t)>(&ConfigMap::edit),
             py::arg("key"), py::arg("value"))
      .def("edit_double", static_cast<void (ConfigMap::*)(const std::string&, double)>(&ConfigMap::edit),
             py::arg("key"), py::arg("value"))
      .def("edit_str", static_cast<void (ConfigMap::*)(const std::string&, std::string)>(&ConfigMap::edit),
             py::arg("key"), py::arg("value"))
      ...
      .def("to_string", &ConfigMap::toString, py::arg("separator") = "\t", py::arg("new_line") = "\n")
      .def("from_string", &ConfigMap::fromString, py::arg("src"), py::arg("separator") = "\t", py::arg("new_line") = "\n")
      .def("clone_into", &ConfigMap::cloneInto, py::arg("dest"))
      .def("load_from", &ConfigMap::loadFrom, py::arg("src"))
      .def("to_file", &ConfigMap::toFile, py::arg("fname"), py::arg("separator") = ",", py::arg("new_line") = "\n")
      .def("from_file", &ConfigMap::fromFile, py::arg("fname"), py::arg("separator") = ",", py::arg("new_line") = "\n")
      .def("from_carg", [](INTELLI::ConfigMap& self, int argc, std::vector<std::string> argv) {
      ...
      .def("try_u64", &ConfigMap::tryU64, py::arg("key"), py::arg("default_value") = 0, py::arg("show_warning") = false)
      .def("try_i64", &ConfigMap::tryI64, py::arg("key"), py::arg("default_value") = 0, py::arg("show_warning") = false)
      .def("try_string", &ConfigMap::tryString, py::arg("key"), py::arg("default_value") = "", py::arg("show_warning") = false)
